...
Secrets.LoseScreen.prototype = {
	create: function () {
		var text = this.game.add.text(this.game.camera.width*0.05, this.game.camera.height*0.4, "The Government \nCaptured You!", { font: "65px Arial", fill: "#FFFFFF", align: "center" });
